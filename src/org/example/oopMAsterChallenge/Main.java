...
//
//For the base Hamburger class, there will need to be four variables to represent the four basic ingredients of the hamburger,
// name, meat, price, and breadRollType. The price variable should be of type double, while the other three are of type String.
...
// Those should be declared with these names: addition1Name, addition1Price, addition2Name,
// addition2Price, addition3Name, addition3Price, addition4Name, and addition4Price.
...
// if any, and the total price. Remember that a name and price must be accepted as parameters in the first four
// methods so that the price of the hamburger is adjusted accordingly. These methods should be named addHamburgerAddition1,
// addHamburgerAddition2, addHamburgerAddition3, addHamburgerAddition4, and itemizehamburger.
// The first four methods do not return values, but the last method does return the total price
// of the hamburger of type double, which includes the base price of the hamburger plus any additional items.
//
...
// healthyExtra1Price, healthyExtra2Name, and healthyExtra2Price.
